...
class ibkr(Exchange):
    """Broker adapter scaffold for Interactive Brokers. Configure options['brokerAdapter'] with deterministic callbacks to bridge the vendor SDK/API."""

    def describe(self):
        return self.deep_extend(super(ibkr, self).describe(), {
            'id': 'ibkr',
            ...
            'urls': {'www': 'https://www.interactivebrokers.com', 'doc': ['https://interactivebrokers.github.io/cpwebapi/'], 'api': {'broker': 'ibkr://local-adapter'}},
