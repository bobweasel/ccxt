 ...
 * @class ig
 * @augments Exchange
 * @description Broker adapter scaffold for IG. Configure options.brokerAdapter with deterministic callbacks to bridge the vendor SDK/API.
 */
export default class ig extends Exchange {
    describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                ...
                'doc': [ 'https://labs.ig.com/rest-trading-api-guide' ],
                'api': { 'broker': 'ig://local-adapter' },
            },
